...
from users.views.views_for_api import UserAuthorizationView, UserProfileView, UserInputInviteCodeView
...
urlpatterns = [
    ...
    path('api/invite-code/', UserInputInviteCodeView.as_view(), name='input-code'),
